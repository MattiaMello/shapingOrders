...
if (isset($_POST['submit'])) {
    ...
    $updateProduct = $pd->productupdate($_POST, $_FILES, $id); /// belong to the product class
}
?>
                    ...
                    <form action="" method="post" enctype="multipart/form-data">
                        <table class="form">
                            ...
                            <tr>
                                ...
                                <td>
                                    <select id="select" name="brandId">
                                        ...
                                        ?>
                                                <option <?php
                                                        if ($value['brandId'] == $result['brandId']) { ?> selected="selected" <?php } ?> value="<?php echo $result['brandId'] ?>"><?php echo $result['brandName']; ?></option>
                                        <?php }
                                        } ?>
                                    </select>
                                </td>
                            ...
                            <tr>
                                ...
                                <td>
                                    <img src="<?php echo $value['image']; ?>" width="200px" height="80px" />
                                    <br>
